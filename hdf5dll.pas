...
// Downloaded from http://hdf-forum.184993.n3.nabble.com/Delphi-interface-for-hdf5-dll-1-8-19-amp-1-10-1-td4029751.html
...
type
  ...
  PPH5AC_cache_image_config_t = ^PH5AC_cache_image_config_t;
  H5AC_cache_image_config_t = record
    version: Integer;
    generate_image: hbool_t;
    save_resize_status: hbool_t;
    entry_ageout: Integer;
  end;
...
type
  ...
  H5F_fspace_strategy_t =
    (H5F_FSPACE_STRATEGY_FSM_AGGR,  (* Mechanisms: free-space managers, aggregators, and virtual file drivers *)
...
type
  ...
  H5FD_class_t = record
    ...
    flush: function(file_: Pointer {PH5FD_t}; dxpl_id: hid_t; closing: hbool_t): herr_t; cdecl;
...
type
  ...
  H5FD_t = record
    ...
    access_flags: Cardinal;  (* File access flags (from create or open) *)
...
type
  ...
  type
    ...
    TH5Fset_latest_format = function(file_id: hid_t; latest_format: hbool_t): herr_t; cdecl;
    ...
    TH5Freset_page_buffering_stats = function(file_id: hid_t): herr_t; cdecl;
    TH5Fget_page_buffering_stats = function(file_id: hid_t; accesses: PCardinal; hits: PCardinal; misses: PCardinal; evictions: PCardinal; bypasses: PCardinal): herr_t; cdecl;
    TH5Fget_mdc_image_info = function(file_id: hid_t; image_addr: Phaddr_t; image_size: Phsize_t): herr_t; cdecl;
    ...
    TH5FDflush = function(file_: PH5FD_t; dxpl_id: hid_t; closing: hbool_t): herr_t; cdecl;
    ...
    TH5Pset_file_space_strategy = function(plist_id: hid_t; strategy: H5F_fspace_strategy_t; persist: hbool_t; threshold: hsize_t): herr_t; cdecl;
    TH5Pget_file_space_strategy = function(plist_id: hid_t; strategy: PH5F_fspace_strategy_t; persist: Phbool_t; threshold: Phsize_t): herr_t; cdecl;
    TH5Pset_file_space_page_size = function(plist_id: hid_t; fsp_size: hsize_t): herr_t; cdecl;
    TH5Pget_file_space_page_size = function(plist_id: hid_t; fsp_size: Phsize_t): herr_t; cdecl;
    ...
    TH5Pset_evict_on_close = function(fapl_id: hid_t; evict_on_close: hbool_t): herr_t; cdecl;
    TH5Pget_evict_on_close = function(fapl_id: hid_t; evict_on_close: Phbool_t): herr_t; cdecl;
    TH5Pset_mdc_image_config = function(plist_id: hid_t; config_ptr: PH5AC_cache_image_config_t): herr_t; cdecl;
    TH5Pget_mdc_image_config = function(plist_id: hid_t; config_ptr: PH5AC_cache_image_config_t): herr_t; cdecl;
    TH5Pset_page_buffer_size = function(plist_id: hid_t; buf_size: size_t; min_meta_per: Cardinal; min_raw_per: Cardinal): herr_t; cdecl;
    TH5Pget_page_buffer_size = function(plist_id: hid_t; buf_size: Psize_t; min_meta_per: PCardinal; min_raw_per: PCardinal): herr_t; cdecl;
  ...
  private
    ...
    FH5Fset_latest_format: TH5Fset_latest_format;
    ...
    FH5Freset_page_buffering_stats: TH5Freset_page_buffering_stats;
    FH5Fget_page_buffering_stats: TH5Fget_page_buffering_stats;
    FH5Fget_mdc_image_info: TH5Fget_mdc_image_info;
    ...
    FH5Pset_file_space_strategy: TH5Pset_file_space_strategy;
    FH5Pget_file_space_strategy: TH5Pget_file_space_strategy;
    FH5Pset_file_space_page_size: TH5Pset_file_space_page_size;
    FH5Pget_file_space_page_size: TH5Pget_file_space_page_size;
    ...
    FH5Pset_evict_on_close: TH5Pset_evict_on_close;
    FH5Pget_evict_on_close: TH5Pget_evict_on_close;
    FH5Pset_mdc_image_config: TH5Pset_mdc_image_config;
    FH5Pget_mdc_image_config: TH5Pget_mdc_image_config;
    FH5Pset_page_buffer_size: TH5Pset_page_buffer_size;
    FH5Pget_page_buffer_size: TH5Pget_page_buffer_size;
  ...
  public
    ...
    property H5Fset_latest_format: TH5Fset_latest_format read FH5Fset_latest_format;
    ...
    property H5Freset_page_buffering_stats: TH5Freset_page_buffering_stats read FH5Freset_page_buffering_stats;
    property H5Fget_page_buffering_stats: TH5Fget_page_buffering_stats read FH5Fget_page_buffering_stats;
    property H5Fget_mdc_image_info: TH5Fget_mdc_image_info read FH5Fget_mdc_image_info;
    ...
    property H5Pset_file_space_strategy: TH5Pset_file_space_strategy read FH5Pset_file_space_strategy;
    property H5Pget_file_space_strategy: TH5Pget_file_space_strategy read FH5Pget_file_space_strategy;
    property H5Pset_file_space_page_size: TH5Pset_file_space_page_size read FH5Pset_file_space_page_size;
    property H5Pget_file_space_page_size: TH5Pget_file_space_page_size read FH5Pget_file_space_page_size;
    ...
    property H5Pset_evict_on_close: TH5Pset_evict_on_close read FH5Pset_evict_on_close;
    property H5Pget_evict_on_close: TH5Pget_evict_on_close read FH5Pget_evict_on_close;
    property H5Pset_mdc_image_config: TH5Pset_mdc_image_config read FH5Pset_mdc_image_config;
    property H5Pget_mdc_image_config: TH5Pget_mdc_image_config read FH5Pget_mdc_image_config;
    property H5Pset_page_buffer_size: TH5Pset_page_buffer_size read FH5Pset_page_buffer_size;
    property H5Pget_page_buffer_size: TH5Pget_page_buffer_size read FH5Pget_page_buffer_size;
...
begin
  ...
  @FH5Fset_latest_format := GetDllProc(FHandle, 'H5Fset_latest_format');
  ...
  @FH5Freset_page_buffering_stats := GetDllProc(FHandle, 'H5Freset_page_buffering_stats');
  @FH5Fget_page_buffering_stats := GetDllProc(FHandle, 'H5Fget_page_buffering_stats');
  @FH5Fget_mdc_image_info := GetDllProc(FHandle, 'H5Fget_mdc_image_info');
  ...
  @FH5Pset_file_space_strategy := GetDllProc(FHandle, 'H5Pset_file_space_strategy');
  @FH5Pget_file_space_strategy := GetDllProc(FHandle, 'H5Pget_file_space_strategy');
  @FH5Pset_file_space_page_size := GetDllProc(FHandle, 'H5Pset_file_space_page_size');
  @FH5Pget_file_space_page_size := GetDllProc(FHandle, 'H5Pget_file_space_page_size');
  ...
  @FH5Pset_evict_on_close := GetDllProc(FHandle, 'H5Pset_evict_on_close');
  @FH5Pget_evict_on_close := GetDllProc(FHandle, 'H5Pget_evict_on_close');
  @FH5Pset_mdc_image_config := GetDllProc(FHandle, 'H5Pset_mdc_image_config');
  @FH5Pget_mdc_image_config := GetDllProc(FHandle, 'H5Pget_mdc_image_config');
  @FH5Pset_page_buffer_size := GetDllProc(FHandle, 'H5Pset_page_buffer_size');
  @FH5Pget_page_buffer_size := GetDllProc(FHandle, 'H5Pget_page_buffer_size');
